...
- [ ] A.1 `npm run qa:local` verde
- [ ] A.2 commit del WIP + runbook
- [ ] B.1 lectura CLI solo-lectura del runtime de producción
- [ ] B.2 par de conexiones consistente verificado (opción b en memoria)
- [ ] B.3 fingerprint confirmado
- [ ] B.4 `inspect` PASS archivado
- [ ] C.1 sonda firewall live (firewall o fallback 503)
